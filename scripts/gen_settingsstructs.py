...
GlobalPrefs = [
	...
	Field("MainWindowBackground", Color, RGB(0xFF, 0xFF, 0xD4, a=0x80),
		"background color of the non-document windows",
		expert=True),
	Field("NoDocBgColor", Color, RGB(0x99, 0x99, 0x99, a=0x80),
		"background color of the document windows",
		expert=True),
	Field("DocBgColor", Color, RGB(0xFF, 0xFF, 0xFF, a=0x80),
		"background color of the non-document windows",
		expert=True),
	Field("DocTextColor", Color, RGB(0x00, 0x00, 0x00, a=0x80),
		"text color of the document",
		expert=True),
	Field("TocBgColor", Color, RGB(0xFF, 0xFF, 0xFF, a=0x80),
		"background color of the table of content",
		expert=True),
	Field("FavBgColor", Color, RGB(0xFF, 0xFF, 0xFF, a=0x80),
	...
	Field("EnableSplitWindow", Bool, False,
		"if true, we allow to split the window",
		expert=True),
	Field("EnableTab", Bool, False,
		"if true, we allow to use tab",
		expert=True),
	Field("TabVisible", Bool, False,
		"if true, we show the tabs",
		expert=True),
	Field("ToolbarForEachPanel", Bool, False,
		"if true, assign a toolbar for each panel",
		expert=True),
	Field("SidebarForEachPanel", Bool, False,
		"if true, assing a sidebar for each panel",
		expert=True),
	Field("ToolbarForEachPanelNew", Bool, False,
		"...",
		expert=True),
	Field("SidebarForEachPanelNew", Bool, False,
		"...",
		expert=True),
