...
GlobalPrefs = [
	...
	Field("MainWindowBackground", Color, RGB(0xFF, 0xFF, 0xD4, a=0x80),
		...
		expert=True),
	Field("NoDocBgColor", Color, 0x80999999,
		"background color of the document windows",
		expert=True),
	Field("DocBgColor", Color, 0x80FFFFFF,
		"background color of the non-document windows",
		expert=True),
	Field("DocTextColor", Color, 0x80000000,
		"text color of the document",
		expert=True),
	Field("TocBgColor", Color, 0x80FFFFFF,
		"background color of the table of content",
		expert=True),
	Field("FavBgColor", Color, 0x80FFFFFF,
